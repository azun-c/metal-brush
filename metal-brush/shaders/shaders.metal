...
simpleVertexShader(const uint vertexID [[ vertex_id ]],
                   const device FreeDrawSimpleVertex *vertices [[ buffer(FreeDrawVertexInputIndexVertices) ]])
{
...
textureVertexShader(const uint vertexID [[ vertex_id ]],
                    ...
                    constant float &aspectRatio [[ buffer(FreeDrawVertexInputIndexAspectRatio) ]])
{
